...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (form) {
        form.addEventListener('submit', async (e) => {
            ...
            try {
                // 1. If running locally via VSCode Live Server (Port 5500), hit the Node backend on Port 5000.
                // 2. If running on Render (Web Service), use the relative route.
                const isLocal = window.location.hostname === '127.0.0.1' || window.location.hostname === 'localhost' || window.location.protocol === 'file:';
                const API_URL = isLocal ? 'http://localhost:5000/api/register' : '/api/register';
...
>>>>>>> 41ea2255480d927188d0f7bd881c32e0117d6206
